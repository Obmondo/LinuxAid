...
class profile::package_management::packagesign (
  ...
  Integer[0]                  $snapshot_retention_days = $role::package_management::repo::snapshot::retention_days,
  ...
  Optional[String]            $script_tag       = $role::package_management::repo::packagesign::script_tag,
  String                      $nginx_path       = $role::package_management::repo::nginx_path,
  String                      $nginx_tag        = $role::package_management::repo::nginx_tag,
  Optional[String]            $snapshot_tag     = $role::package_management::repo::snapshot::image_tag,
  Optional[Enum['gitlab']]    $provider         = $role::package_management::repo::provider,
  Optional[String]            $signing_password = $role::package_management::repo::packagesign::signing_password,
