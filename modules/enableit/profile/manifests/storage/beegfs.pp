...
class profile::storage::beegfs (
  ...
  Array[Stdlib::Absolutepath] $storage_directory = $::role::storage::beegfs::storage::directory,
  ...
  Stdlib::Port                $admon_http_port   = $::role::storage::beegfs::admon::http_port,
  Stdlib::Port                $storage_port      = $::role::storage::beegfs::storage::port,
  Stdlib::Port                $client_udp_port   = $::role::storage::beegfs::client::udp_port,
  Stdlib::Port                $meta_port         = $::role::storage::beegfs::meta::port,
  Stdlib::Port                $mgmtd_port        = $::role::storage::beegfs::mgmtd::port,
