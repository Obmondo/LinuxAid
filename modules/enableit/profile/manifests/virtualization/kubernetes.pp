...
class profile::virtualization::kubernetes (
  ...
  Optional[String]            $etcd_ca_crt                = $::role::virtualization::kubernetes::role::controller::etcd_ca_crt,
  Optional[String] $etcd_ca_key                           = $::role::virtualization::kubernetes::role::controller::etcd_ca_key,
  ...
  Optional[String]            $kubernetes_ca_crt          = $::role::virtualization::kubernetes::role::controller::kubernetes_ca_crt,
  Optional[String] $kubernetes_ca_key                     = $::role::virtualization::kubernetes::role::controller::kubernetes_ca_key,
  String           $discovery_token_hash                  = $::role::virtualization::kubernetes::discovery_token_hash,
  Optional[String]            $front_proxy_ca_crt         = $::role::virtualization::kubernetes::role::controller::front_proxy_ca_crt,
  Optional[String] $front_proxy_ca_key                    = $::role::virtualization::kubernetes::role::controller::front_proxy_ca_key,
  Optional[String]            $sa_pub                     = $::role::virtualization::kubernetes::role::controller::sa_pub,
  Optional[String] $sa_key                                = $::role::virtualization::kubernetes::role::controller::sa_key,
  ...
  Optional[String]            $etcd_initial_cluster       = $::role::virtualization::kubernetes::role::controller::etcd_initial_cluster,
