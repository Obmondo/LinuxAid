...
class profile::projectmanagement::gitlab (
  ...
  Hash                                 $mattermost_config      = $role::projectmanagement::gitlab::mattermost::config,
  Boolean                              $backup                 = $role::projectmanagement::gitlab::backup,
  Integer[0,23]                        $backup_cron_hour       = $role::projectmanagement::gitlab::backup::cron_hour,
  Optional[Stdlib::Absolutepath]       $backup_path            = $role::projectmanagement::gitlab::backup::path,
  Integer[1,default]                   $backup_keep_days       = $role::projectmanagement::gitlab::backup::keep_days,
  ...
  Optional[String]                     $registry_ssl_cert      = $role::projectmanagement::gitlab::registry::ssl_cert,
  Optional[String]                     $registry_ssl_key       = $role::projectmanagement::gitlab::registry::ssl_key,
  Stdlib::Fqdn                         $registry_domain        = $role::projectmanagement::gitlab::registry::domain,
  Optional[Array[Stdlib::IP::Address]] $trusted_proxies        = $role::projectmanagement::gitlab::registry::trusted_proxies,
  Optional[String]                     $mattermost_ssl_cert    = $role::projectmanagement::gitlab::mattermost::ssl_cert,
  Optional[String]                     $mattermost_ssl_key     = $role::projectmanagement::gitlab::mattermost::ssl_key,
  Stdlib::Fqdn                         $mattermost_domain      = $role::projectmanagement::gitlab::mattermost::domain,
  Array[String]                        $public_keys            = $role::projectmanagement::gitlab::backup::public_keys,
  Eit_types::User                      $backupcron_user        = $role::projectmanagement::gitlab::backup::cron_user,
  ...
  Optional[Stdlib::Fqdn]               $pages_domain           = $role::projectmanagement::gitlab::enable_pages::domain,
  Optional[String]                     $pages_ssl_cert         = $role::projectmanagement::gitlab::enable_pages::ssl_cert,
  Optional[String]                     $pages_ssl_key          = $role::projectmanagement::gitlab::enable_pages::ssl_key,
  ...
  Optional[Eit_types::Gitlab::Prometheus_exporters] $prometheus_exporters = $role::projectmanagement::gitlab::prometheus::exporters,

  Cron::Hour $garbage_cleanup_job_hour = $role::projectmanagement::gitlab::registry::garbage_cleanup_job_hour,
