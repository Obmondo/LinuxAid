...
class profile::system::authentication::pam (
  ...
  Array[Tuple[Integer[0,99], String]]  $session_lines           = $common::user_management::authentication::pam::session_lines,
  Array[Tuple[Integer[0,99], String]]  $password_auth_lines     = $common::user_management::authentication::pam::password_auth_lines,
  Array[Tuple[Integer[0,99], String]]  $password_account_lines  = $common::user_management::authentication::pam::password_account_lines,
  Array[Tuple[Integer[0,99], String]]  $password_password_lines = $common::user_management::authentication::pam::password_password_lines,
  Array[Tuple[Integer[0,99], String]]  $password_session_lines  = $common::user_management::authentication::pam::password_session_lines,
  Array[Tuple[Integer[0,99], String]]  $sshd_auth_lines         = $common::user_management::authentication::pam::sshd_auth_lines,
  Array[Tuple[Integer[0,99], String]]  $sshd_account_lines      = $common::user_management::authentication::pam::sshd_account_lines,
  Array[Tuple[Integer[0,99], String]]  $sshd_password_lines     = $common::user_management::authentication::pam::sshd_password_lines,
  Array[Tuple[Integer[0,99], String]]  $sshd_session_lines      = $common::user_management::authentication::pam::sshd_session_lines,
) {
