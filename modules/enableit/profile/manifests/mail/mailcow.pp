...
class profile::mail::mailcow (
  ...
  Sensitive[String]           $dbroot                   = $role::mail::mailcow::dbroot,
  Sensitive[String]           $dbpass                   = $role::mail::mailcow::dbpass,
  ...
  file { default:
    ...
    '/opt/obmondo/docker-compose/mailcow/.env':
      ...
      content => anything_to_ini({
        ...
        'DBNAME'                        => 'mailcow',
        'DBUSER'                        => 'mailcow',
        'DBPASS'                        => unwrap($dbpass),
        'DBROOT'                        => unwrap($dbroot),
        'HTTP_BIND'                     => $http_bind,
    ...
    '/opt/obmondo/docker-compose/mailcow/docker-compose.yml':
      ...
      content => epp('profile/mail/mailcow/docker-compose.yml.epp', {
        ...
        'unbound_image'   => 'ghcr.io/mailcow/unbound:1.23',
        'mysql_image'     => 'docker.io/mariadb:10.11',
        'redis_image'     => 'docker.io/redis:7.4.2-alpine',
        'clamd_image'     => 'ghcr.io/mailcow/clamd:1.70',
        'rspamd_image'    => 'ghcr.io/mailcow/rspamd:2.0',
        'php_fpm_image'   => 'ghcr.io/mailcow/phpfpm:1.92',
        'sogo_image'      => 'ghcr.io/mailcow/sogo:1.129',
        'dovecot_image'   => 'ghcr.io/mailcow/dovecot:2.31',
        ...
        'acme_image'      => 'ghcr.io/mailcow/acme:1.91',
        'netfilter_image' => 'ghcr.io/mailcow/netfilter:1.61',
        'watchdog_image'  => 'ghcr.io/mailcow/watchdog:2.06',
        'dockerapi_image' => 'ghcr.io/mailcow/dockerapi:2.10',
