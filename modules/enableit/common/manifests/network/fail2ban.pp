...
#
# Thin wrapper around profile::network::fail2ban. Disabled by default; enable
# it per host from linuxaid-config hiera with
# `common::network::fail2ban::enable: true`.
#
...
class common::network::fail2ban (
  ...
  include profile::network::fail2ban
}
