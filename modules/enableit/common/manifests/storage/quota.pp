...
class common::storage::quota (
  ...
  if $_install {
    # Package before 0.1.1 has a wrong PREFIX causing PAM to fail.
    # Fixed in https://gitlab.enableit.dk/obmondo/obmondo-disk-quotas/-/commit/4182a40b30a0b2a3e9edbb99934a043ccb320a8b.
